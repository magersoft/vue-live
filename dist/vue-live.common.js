(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('hash-sum'), require('vue-inbrowser-compiler'), require('prismjs'), require('prismjs/components/prism-jsx.min'), require('vue-prism-editor'), require('debounce')) :
  typeof define === 'function' && define.amd ? define(['exports', 'hash-sum', 'vue-inbrowser-compiler', 'prismjs', 'prismjs/components/prism-jsx.min', 'vue-prism-editor', 'debounce'], factory) :
  (global = global || self, factory(global.VueLive = {}, global.hash, global.vueInbrowserCompiler, null, null, global.PrismEditor, global.debounce));
}(this, function (exports, hash, vueInbrowserCompiler, prismjs, prismJsx_min, PrismEditor, debounce) { 'use strict';
  ...
  var script = {
    ...
    methods: {
      ...
      renderComponent: function renderComponent(code) {
        ...
        try {
          var renderedComponent = vueInbrowserCompiler.compile(code, this.jsx ? {
            jsx: "__pragma__(h)",
          ...
          if (renderedComponent.script) {
            ...
            this.$emit("detect-language", vueInbrowserCompiler.isCodeVueSfc(code) ? "vue" : "js"); // compile and execute the script
            // it can be:
        ...
        if (style) {
          ...
          vueInbrowserCompiler.addScopedStyle(style, this.scope);
        }
  ...
  exports.VueLive = VueLive;
  exports.VueLiveEditor = VueLiveEditor;
  exports.VueLivePreview = VueLivePreview;
